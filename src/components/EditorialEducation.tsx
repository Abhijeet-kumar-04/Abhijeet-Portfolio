...
export function EditorialEducation() {
  return (
    <section className="w-full max-w-7xl mx-auto px-6 md:px-12 py-24 border-t border-white/5 relative" id="education">
      ...
      {/* Background Glow */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-3xl h-[400px] bg-purple-600/5 blur-[120px] pointer-events-none rounded-full"></div>

      <div className="text-center relative z-10 mb-20">
        <h2 className="font-sans font-bold text-4xl md:text-5xl text-white mb-4">
          Academic <span className="text-purple-500">Background</span>
        </h2>
        <p className="text-gray-400 font-light text-lg">My educational qualifications.</p>
      </div>

      <div className="relative max-w-5xl mx-auto">
        {/* The Central Glowing Purple Timeline Line */}
        <div className="absolute left-[39px] md:left-1/2 top-0 bottom-0 w-[2px] bg-gradient-to-b from-purple-500/0 via-purple-500/80 to-purple-500/0 md:-translate-x-1/2 shadow-[0_0_15px_rgba(168,85,247,0.5)]"></div>
          ...
          {portfolioData.academicHistory.map((edu, idx) => {
            ...
            return (
              ...
              >
                ...
                {/* The Glowing Node */}
                <div className="absolute left-4 md:left-1/2 w-12 h-12 -translate-x-1/2 rounded-full border-2 border-purple-500 bg-[#0a0a0a] z-10 flex items-center justify-center shadow-[0_0_20px_rgba(168,85,247,0.8)]">
                ...
                <div className="w-full pl-24 md:pl-0 md:w-[45%]">
                  <div className="bg-[#0a0a0a]/80 backdrop-blur-xl border border-white/5 rounded-2xl p-6 md:p-8 hover:border-purple-500/30 transition-all duration-500 shadow-[0_15px_30px_rgba(0,0,0,0.6)] group">
                    ...
                    <div className="flex items-start gap-4 md:gap-6">
                      ...
                      <div>
                        ...
                        <p className="text-purple-400 text-sm md:text-base font-medium mb-1">{edu.degree}</p>
