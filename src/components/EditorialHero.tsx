      ...
      <div className="flex-1 flex flex-col relative pt-24 pb-8 px-6 md:px-12 max-w-7xl mx-auto w-full">
        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-8 items-center lg:items-start flex-1 w-full mt-4 md:mt-8">
          ...
          <motion.div
            ...
            className="w-full lg:w-[45%] flex justify-center lg:justify-end items-center mt-8 lg:mt-0 z-10"
          >
            <div className="relative w-full max-w-[280px] md:max-w-[340px] lg:max-w-[380px] xl:max-w-[400px] aspect-[3/4] flex items-center justify-center transform lg:-translate-y-4">
